    ...
    <>
      ...
      >
        <div>
          ...
          <section className='relative h-[80vh] min-h-[600px] py-12'>
            ...
            <div className='absolute inset-0 flex items-center justify-center text-center'>
              <div className='space-y-6 max-w-4xl px-4'>
                ...
                <p className='text-xl md:text-2xl text-white/90 mb-8 max-w-2xl mx-auto'>                  Discover why we are the best Indian restaurant in Ash Fork with our rich flavors and aromatic spices of traditional Punjabi cooking at Spice Grill & Bar.
                </p>
                <div className='flex flex-col sm:flex-row gap-4 justify-center'>
                  <MyLink href='/menu' size='lg' className='bg-brand-orange hover:bg-brand-orange/90 text-lg sm:text-lg'>
                    View Our Menu
                  </MyLink>
                </div>
          ...
          {/* Featured Section */}
          <section className='py-20 bg-gradient-to-b from-amber-50/50 py-12'>
            <div className='container mx-auto px-4'>
              <div className='text-center mb-16'>
                <h2 className='font-serif text-4xl mb-4'>Popular Punjabi Dishes from our Indian Restaurant</h2>
                <p className='text-gray-600 max-w-2xl mx-auto'>
                  Savor our most beloved dishes, crafted with care using traditional Punjabi recipes and the finest ingredients
                </p>
              </div>
                  ...
                  .map((item, index) => (
                    ...
                    >
                      ...
                      <CardContent className='p-6'>
                        ...
                        <MyLink href='/menu' variant='link' className='text-brand-orange hover:text-brand-orange/90 p-0'>
          ...
          <section className='py-20 bg-white py-12'>
            <div className='container mx-auto px-4'>
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
                ...
                <div className='space-y-6'>
                  ...
                  <p className='text-gray-600'>
                    Welcome to Spice Grill & Bar, your premier Indian restaurant in Ash Fork, where traditional Indian flavors meet modern culinary excellence. For over a decade, we&apos;ve been serving authentic Indian cuisine made with the finest ingredients and time-honored recipes passed down through generations.
                  </p>
                  <p className='text-gray-600'>
